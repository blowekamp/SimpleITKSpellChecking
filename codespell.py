...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="append",
        dest="dict",
        help="File that contains words that will be ignored. Argument can be passed multiple times."
    ...
    parser.add_argument(
        ...
        action="append",
        dest="exclude",
        help="Specify regex for excluding files. Argument can be passed multiple times.",
    )
